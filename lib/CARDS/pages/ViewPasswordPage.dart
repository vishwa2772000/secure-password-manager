...
import 'package:personal/CARDS/pages/AddPasswordPage.dart';
...
class ViewPassword extends StatefulWidget {
  ...
  ViewPassword({Key key, this.password,Function() triggerRefetch,
    Password currentNote}) : super(key: key) {
