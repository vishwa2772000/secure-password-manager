...
import 'package:personal/CARDS//bloc/PasswordBloc.dart';
import 'package:personal/CARDS/database/Database.dart';
import 'package:personal/CARDS/model/PasswordModel.dart';
import 'package:personal/CARDS/pages/ViewPasswordPage.dart';
...
class _PasswordHomepageState extends State<PasswordHomepage> {
  ...
  setNotesFromDB() async {
    ...
    var fetchedNotes = await DBProvider.db.getAllPasswords();
    setState(() {
  ...
  void gotoEditNote() {
    Navigator.push(
        ...
        CupertinoPageRoute(
            builder: (context) =>
                AddPassword(triggerRefetch: refetchNotesFromDB)));
  }
  ...
  openNoteToRead(Password noteData) async {
    setState(() {
